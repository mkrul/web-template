...
const countryCodes = [
  ...
  { code: 'BJ', en: 'Benin', fr: 'Bénin', es: 'Benín', de: 'Benin' },
  { code: 'BM', en: 'Bermuda', fr: 'Bermudes', es: 'Bermudas', de: 'Bermuda' },
  { code: 'BT', en: 'Bhutan', fr: 'Bhoutan', es: 'Bután', de: 'Bhutan' },
  ...
  { code: 'KY', en: 'Cayman Islands', fr: 'Îles Caïmans', es: 'Islas Caimán', de: 'Kaimaninseln' },
  ...
  { code: 'CN', en: 'China', fr: 'Chine', es: 'China', de: 'China' },
  { code: 'CX', en: 'Christmas Island', fr: 'Île Christmas', es: 'Isla de Navidad', de: 'Weihnachtsinsel' },
  ...
  { code: 'KM', en: 'Comoros', fr: 'Comores', es: 'Comoras', de: 'Komoren' },
  ...
  { code: 'CI', en: 'Côte d\'Ivoire', fr: 'Côte d\'Ivoire', es: 'Costa de Marfil', de: 'Elfenbeinküste' },
  ...
  { code: 'CZ', en: 'Czech Republic', fr: 'République tchèque', es: 'República Checa', de: 'Tschechische Republik' },
  { code: 'DK', en: 'Denmark', fr: 'Danemark', es: 'Dinamarca', de: 'Dänemark' },
  { code: 'DJ', en: 'Djibouti', fr: 'Djibouti', es: 'Yibuti', de: 'Dschibuti' },
  { code: 'DM', en: 'Dominica', fr: 'Dominique', es: 'Dominica', de: 'Dominica' },
  ...
  { code: 'FO', en: 'Faroe Islands', fr: 'Îles Féroé', es: 'Islas Feroe', de: 'Färöer' },
  { code: 'FJ', en: 'Fiji', fr: 'Fidji', es: 'Fiyi', de: 'Fidschi' },
  ...
  { code: 'TF', en: 'French Southern Territories', fr: 'Terres australes françaises', es: 'Territorios Australes Franceses', de: 'Französische Süd- und Antarktisgebiete' },
  ...
  { code: 'GW', en: 'Guinea-Bissau', fr: 'Guinée-Bissau', es: 'Guinea-Bisáu', de: 'Guinea-Bissau' },
  { code: 'GY', en: 'Guyana', fr: 'Guyana', es: 'Guayana', de: 'Guyana' },
  { code: 'HT', en: 'Haiti', fr: 'Haïti', es: 'Haití', de: 'Haiti' },
  { code: 'HM', en: 'Heard Island and McDonald Islands', fr: 'Île Heard et îles McDonald', es: 'Islas Heard y McDonald', de: 'Heard und McDonaldinseln' },
  { code: 'VA', en: 'Holy See (Vatican City State)', fr: 'Saint-Siège (État de la Cité du Vatican)', es: 'Santa Sede (Ciudad del Vaticano)', de: 'Heiliger Stuhl' },
  ...
  { code: 'IR', en: 'Iran', fr: 'Iran', es: 'Irán', de: 'Iran' },
  { code: 'IQ', en: 'Iraq', fr: 'Irak', es: 'Irak', de: 'Irak' },
  { code: 'IE', en: 'Ireland', fr: 'Irlande', es: 'Irlanda', de: 'Irland' },
  { code: 'IM', en: 'Isle of Man', fr: 'Île de Man', es: 'Isla de Man', de: 'Insel Man' },
  ...
  { code: 'JE', en: 'Jersey', fr: 'Jersey', es: 'Jersey', de: 'Jersey' },
  { code: 'JO', en: 'Jordan', fr: 'Jordanie', es: 'Jordania', de: 'Jordanien' },
  { code: 'KZ', en: 'Kazakhstan', fr: 'Kazakhstan', es: 'Kazajistán', de: 'Kasachstan' },
  { code: 'KE', en: 'Kenya', fr: 'Kenya', es: 'Kenia', de: 'Kenia' },
  { code: 'KI', en: 'Kiribati', fr: 'Kiribati', es: 'Kiribati', de: 'Kiribati' },
  { code: 'KP', en: 'North Korea', fr: 'Corée du Nord', es: 'Corea del Norte', de: 'Nordkorea' },
  { code: 'KR', en: 'South Korea', fr: 'Corée du Sud', es: 'Corea del Sur', de: 'Südkorea' },
  ...
  { code: 'LS', en: 'Lesotho', fr: 'Lesotho', es: 'Lesoto', de: 'Lesotho' },
  ...
  { code: 'ML', en: 'Mali', fr: 'Mali', es: 'Malí', de: 'Mali' },
  ...
  { code: 'FM', en: 'Micronesia', fr: 'Micronésie', es: 'Micronesia', de: 'Mikronesien' },
  { code: 'MD', en: 'Moldova', fr: 'Moldavie', es: 'Moldavia', de: 'Moldau' },
  ...
  { code: 'NF', en: 'Norfolk Island', fr: 'Île Norfolk', es: 'Isla Norfolk', de: 'Norfolkinsel' },
  ...
  { code: 'PW', en: 'Palau', fr: 'Palaos', es: 'Palaos', de: 'Palau' },
  { code: 'PS', en: 'Palestine', fr: 'Palestine', es: 'Palestina', de: 'Palästina' },
  ...
  { code: 'PN', en: 'Pitcairn', fr: 'Pitcairn', es: 'Pitcairn', de: 'Pitcairn' },
  { code: 'PL', en: 'Poland', fr: 'Pologne', es: 'Polonia', de: 'Polen' },
  { code: 'PT', en: 'Portugal', fr: 'Portugal', es: 'Portugal', de: 'Portugal' },
  { code: 'PR', en: 'Puerto Rico', fr: 'Porto Rico', es: 'Puerto Rico', de: 'Puerto Rico' },
  { code: 'QA', en: 'Qatar', fr: 'Qatar', es: 'Catar', de: 'Katar' },
  { code: 'RE', en: 'Réunion', fr: 'Réunion', es: 'Reunión', de: 'Réunion' },
  { code: 'RO', en: 'Romania', fr: 'Roumanie', es: 'Rumania', de: 'Rumänien' },
  { code: 'RU', en: 'Russia', fr: 'Russie', es: 'Rusia', de: 'Russland' },
  ...
  { code: 'SH', en: 'Saint Helena', fr: 'Sainte-Hélène', es: 'Santa Elena', de: 'St. Helena' },
  ...
  { code: 'MF', en: 'Saint Martin (French part)', fr: 'Saint-Martin (partie française)', es: 'San Martín (parte francesa)', de: 'Saint-Martin' },
  ...
  { code: 'RS', en: 'Serbia', fr: 'Serbie', es: 'Serbia', de: 'Serbien' },
  ...
  { code: 'SX', en: 'Sint Maarten (Dutch part)', fr: 'Saint-Martin (partie néerlandaise)', es: 'San Martín (parte neerlandesa)', de: 'Sint Maarten' },
  { code: 'SK', en: 'Slovakia', fr: 'Slovaquie', es: 'Eslovaquia', de: 'Slowakei' },
  { code: 'SI', en: 'Slovenia', fr: 'Slovénie', es: 'Eslovenia', de: 'Slowenien' },
  { code: 'SB', en: 'Solomon Islands', fr: 'Îles Salomon', es: 'Islas Salomón', de: 'Salomonen' },
  { code: 'SO', en: 'Somalia', fr: 'Somalie', es: 'Somalia', de: 'Somalia' },
  { code: 'ZA', en: 'South Africa', fr: 'Afrique du Sud', es: 'Sudáfrica', de: 'Südafrika' },
  { code: 'GS', en: 'South Georgia and the South Sandwich Islands', fr: 'Géorgie du Sud et les îles Sandwich du Sud', es: 'Georgia del Sur e Islas Sandwich del Sur', de: 'Südgeorgien und die Südlichen Sandwichinseln' },
  { code: 'SS', en: 'South Sudan', fr: 'Soudan du Sud', es: 'Sudán del Sur', de: 'Südsudan' },
  ...
  { code: 'SJ', en: 'Svalbard and Jan Mayen', fr: 'Svalbard et île Jan Mayen', es: 'Svalbard y Jan Mayen', de: 'Svalbard und Jan Mayen' },
  { code: 'SZ', en: 'Swaziland', fr: 'Swaziland', es: 'Suazilandia', de: 'Eswatini' },
  { code: 'SE', en: 'Sweden', fr: 'Suède', es: 'Suecia', de: 'Schweden' },
  { code: 'CH', en: 'Switzerland', fr: 'Suisse', es: 'Suiza', de: 'Schweiz' },
  { code: 'SY', en: 'Syria', fr: 'Syrie', es: 'Siria', de: 'Syrien' },
  { code: 'TW', en: 'Taiwan', fr: 'Taïwan', es: 'Taiwán', de: 'Taiwan' },
  ...
  { code: 'TL', en: 'Timor-Leste', fr: 'Timor oriental', es: 'Timor Oriental', de: 'Osttimor' },
  ...
  { code: 'GB', en: 'United Kingdom', fr: 'Royaume-Uni', es: 'Reino Unido', de: 'Vereinigtes Königreich' },
  { code: 'US', en: 'United States', fr: 'États-Unis', es: 'Estados Unidos', de: 'Vereinigte Staaten' },
  { code: 'UM', en: 'United States Minor Outlying Islands', fr: 'Îles mineures éloignées des États-Unis', es: 'Islas Ultramarinas Menores de Estados Unidos', de: 'Kleinere Amerikanische Überseeinseln' },
  ...
  { code: 'VN', en: 'Vietnam', fr: 'Vietnam', es: 'Vietnam', de: 'Vietnam' },
  { code: 'VG', en: 'British Virgin Islands', fr: 'Îles Vierges britanniques', es: 'Islas Vírgenes Británicas', de: 'Britische Jungferninseln' },
  { code: 'VI', en: 'U.S. Virgin Islands', fr: 'Îles Vierges américaines', es: 'Islas Vírgenes de los Estados Unidos', de: 'Amerikanische Jungferninseln' },
...
const getCountryCodes = lang => {
  // Filter to only include United States
  const usOnly = countryCodes.filter(c => c.code === 'US');
  
  // Add the locale here so that the correct translations will be returned.
  // If locale is unknown or the translation is missing, this will default to english country name.
  const codes = usOnly.map(c => {
