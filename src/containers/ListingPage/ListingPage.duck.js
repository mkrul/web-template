...
export const FETCH_MONTHLY_TIME_SLOTS_REQUEST =
  'app/ListingPage/FETCH_MONTHLY_TIME_SLOTS_REQUEST';
export const FETCH_MONTHLY_TIME_SLOTS_SUCCESS =
  'app/ListingPage/FETCH_MONTHLY_TIME_SLOTS_SUCCESS';
export const FETCH_MONTHLY_TIME_SLOTS_ERROR =
  'app/ListingPage/FETCH_MONTHLY_TIME_SLOTS_ERROR';
...
export const FETCH_TIME_SLOTS_FOR_DATE_ERROR =
  'app/ListingPage/FETCH_TIME_SLOTS_FOR_DATE_ERROR';
  ...
  (dispatch, getState, sdk) => {
    ...
    return show
      .then((data) => {
        ...
        const sanitizeConfig = { listingFields, redactLocation: !isOwn };
...
export const loadData =
  (params, search, config) => (dispatch, getState, sdk) => {
    ...
    dispatch(
      setInitialValues({ lineItems: null, inquiryModalOpenForListingId })
    );
    ...
    const canFetchData =
      !isPrivateMarketplace || (isPrivateMarketplace && isAuthorized);
    if (!canFetchData) {
      return Promise.resolve();
    }

    const hasNoViewingRights =
